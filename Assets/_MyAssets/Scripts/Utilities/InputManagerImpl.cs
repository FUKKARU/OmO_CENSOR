...
namespace Scripts.Utilities
{
    ...
    public abstract class AInputManager<T> : MonoBehaviour where T : AInputManager<T>
    {
        ...
        protected MyActions _ia { get; private set; } = null;
        ...
        protected InputInfo Setup(InputAction inputAction, InputType type)
        {
